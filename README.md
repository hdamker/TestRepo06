<a href="https://github.com/camaraproject/TestRepo06/commits/" title="Last Commit"><img src="https://img.shields.io/github/last-commit/camaraproject/TestRepo06?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo06/issues" title="Open Issues"><img src="https://img.shields.io/github/issues/camaraproject/TestRepo06?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo06/pulls" title="Open Pull Requests"><img src="https://img.shields.io/github/issues-pr/camaraproject/TestRepo06?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo06/graphs/contributors" title="Contributors"><img src="https://img.shields.io/github/contributors/camaraproject/TestRepo06?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo06" title="Repo Size"><img src="https://img.shields.io/github/repo-size/camaraproject/TestRepo06?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo06/blob/main/LICENSE" title="License"><img src="https://img.shields.io/badge/License-Apache%202.0-green.svg?style=plastic"></a>
<a href="https://github.com/camaraproject/TestRepo06/releases/latest" title="Latest Release"><img src="https://img.shields.io/github/release/camaraproject/TestRepo06?style=plastic"></a>
...
Sandbox API Repository to describe, develop, document, and test the TestRepo06 Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Sandbox API Repository to describe, develop, document, and test the TestRepo06 Service API(s) within the Sub Project []()
...
Incubating API Repository to evolve and maintain the definitions and documentation of TestRepo06 Service API(s) within the Sub Project []()
...
* Service API(s) “TestRepo06” (see APIBacklog.md) 
...
<!-- Pre-releases of this sub project are available in https://github.com/camaraproject/TestRepo06/releases -->
<!-- The latest public release is available here: https://github.com/camaraproject/TestRepo06/releases/latest -->
<!-- For changes see [CHANGELOG.md](https://github.com/camaraproject/TestRepo06/blob/main/CHANGELOG.md) -->
